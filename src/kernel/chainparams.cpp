...
// Copyright (c) 2026 The NoMoreASICs Developers
...
{
    const char* pszTimestamp = "The Times 30/Apr/2026 NMA Launch - Upper West Side 2026";
...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].threshold = 36288; // 90%
        ...
        vSeeds.emplace_back("nomoreasics.duckdns.org."); // NoMoreASICs
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.MinBIP9WarningHeight = 0;
        consensus.powLimit = uint256{"7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"};
        consensus.nPowTargetTimespan = 10 * 30; // one day
