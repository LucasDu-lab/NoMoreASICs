...
const QString BITCOIN_IPC_PREFIX("nomoreasics:");
    ...
    : QObject(parent)
{
    ...
    // on Mac: sent when you click nomoreasics: links
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(nullptr, tr("Payment request error"),
                tr("Cannot start nomoreasics: click-to-pay handler"));
        }
        else {
...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("nomoreasics://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'nomoreasics://' is not a valid URI. Use 'nomoreasics:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // nomoreasics: URI
    {
        ...
        // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid NoMoreASICs address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
