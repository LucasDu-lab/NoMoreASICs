...
const std::string CURRENCY_UNIT = "NMA"; // One formatted unit
const std::string CURRENCY_ATOM = "sat"; // One indivisible minimum value unit

enum class FeeRateFormat {
    NMA_KVB, //!< Use NMA/kvB fee rate unit
...
public:
    ...
    std::string ToString(FeeRateFormat fee_rate_format = FeeRateFormat::NMA_KVB) const;
